...
import com.dx168.fastdex.sample.SampleApplication;
...
public class AppInfo {
    ...
    public static String applicationId = "com.dx168.fastdex.sample";
     ...
     */
    @SuppressWarnings({"CanBeFinal", "StaticVariableNamingConvention"})
    public static String applicationClass = SampleApplication.class.getName();
