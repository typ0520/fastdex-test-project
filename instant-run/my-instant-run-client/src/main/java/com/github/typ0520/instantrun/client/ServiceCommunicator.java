...
import static com.github.typ0520.instantrun.client.ProtocolConstants.MESSAGE_EOF;
import static com.github.typ0520.instantrun.client.ProtocolConstants.PROTOCOL_IDENTIFIER;
import static com.github.typ0520.instantrun.client.ProtocolConstants.PROTOCOL_VERSION;
...
public class ServiceCommunicator {
    ...
    private static <T> T talkToServiceWithinPortForward(Communicator<T> communicator, int localPort) throws IOException {
        ...
        if (version != PROTOCOL_VERSION) {
            String msg = String.format(Locale.US, "Client and server protocol versions don't match (%1$d != %2$d)", version, PROTOCOL_VERSION);
